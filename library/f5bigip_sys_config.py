...
class ModuleParams(object):
    ...
    def mutually_exclusive(self):
        return [["base", "binary", "default", "exclude_gtm", "gtm_only", "user_only"]]


class F5BigIpSysConfig(F5BigIpUnnamedObject):
    def _set_crud_methods(self):
        self._methods = {"exec_cmd": self._api.tm.sys.config.exec_cmd}
    ...
    def flush(self):
        ...
        try:
            ...
            raise AnsibleF5Error(
                "Could not execute '" + command + "' command: " + exc.message
            )
